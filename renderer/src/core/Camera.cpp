...
void Camera::Move(CameraDirection direction, float speed, float deltaTime)
{
    ...
    switch (direction)
    {
        case CameraDirection::Forward:  m_position += horizontalForward * dist;  break;
        case CameraDirection::Backward: m_position -= horizontalForward * dist;  break;
        case CameraDirection::Right:    m_position += m_right            * dist;  break;
        case CameraDirection::Left:     m_position -= m_right            * dist;  break;
        case CameraDirection::Up:       m_position += moveUp             * dist;  break;
        case CameraDirection::Down:     m_position -= moveUp             * dist;  break;
    }
...
glm::vec3 Camera::GetForward() const { RebuildBasis(); return m_forward; }
glm::vec3 Camera::GetRight()   const { RebuildBasis(); return m_right;   }
glm::vec3 Camera::GetUp()      const { RebuildBasis(); return m_up;      }
